...
public class BlogController {
    ...
    @Operation(
            summary = "Lấy danh sách các bài viết đã đăng",
            description = "Trả về danh sách tóm tắt của tất cả các bài viết đã được duyệt và đăng tải. Mọi người đều có thể truy cập."
    )
    @GetMapping
    ...
    @Operation(
            ...
            description = "Trả về nội dung đầy đủ của một bài viết đã được đăng tải. Mọi người đều có thể truy cập."
    )
    @GetMapping("/{id}")
