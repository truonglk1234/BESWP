...
public class AuthController {
    ...
    @Operation(summary = "Register a new user", description = "Endpoint for new users to register an account. Provide userphone, password, full name, and email.")
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody RegisterDto registerDto) {
        try {
            ...
            return new ResponseEntity<>("User registered successfully! User ID: " + registeredUser.getId(),
                    HttpStatus.CREATED);
    ...
    @Operation(summary = "Login user", description = "Endpoint for users to login using email/phone and password")
